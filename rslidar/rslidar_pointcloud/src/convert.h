...
class BagConvert : public Convert {
 public:
  BagConvert(ros::NodeHandle node, ros::NodeHandle private_nh) : Convert(node, private_nh) {
    private_nh.param("bag_path", bag_path_, std::string(""));
  }
  sensor_msgs::PointCloud2::Ptr processScan(const rslidar_msgs::rslidarScan::ConstPtr& scanMsg);
